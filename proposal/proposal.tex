...
- closed loop modelling can give a good error signal
by using the auditory periphery for the error signal.
other people have done closed loop modelling
already, but only in the context of babbling,
and typically with a scalar ``good or bad''
reinforcement signal.
this doesn't seem to have been applied
to adult speech.
